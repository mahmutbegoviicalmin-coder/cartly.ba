  ...
  return (
    <section className="bg-white border-t border-black/10">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 lg:py-16">
        ...
        <h2 className="text-2xl sm:text-3xl font-extrabold mb-8 text-[#B33000]">
          Galerija
        </h2>
        ...
        >
          ...
          <button
            ...
            className="absolute left-3 top-1/2 -translate-y-1/2 z-20 w-10 h-10 bg-white border border-black/10 flex items-center justify-center hover:border-[#B33000] hover:text-[#B33000] transition-colors"
          >
          ...
          <button
            ...
            className="absolute right-3 top-1/2 -translate-y-1/2 z-20 w-10 h-10 bg-white border border-black/10 flex items-center justify-center hover:border-[#B33000] hover:text-[#B33000] transition-colors"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          {images.map((img, i) => (
            <button
              ...
              className={`relative flex-1 aspect-square bg-[#F5F5F5] overflow-hidden border-2 transition-colors ${
                i === current ? "border-[#B33000]" : "border-transparent hover:border-black/20"
              }`}
            >
              <Image
                src={img.src}
