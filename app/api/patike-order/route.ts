  ...
  try {
    ...
    try {
      ...
      await resend.emails.send({
        ...
        subject: `#NARUDZBA [PATIKE S3] - ${ime} - br.${velicina} x${qty} - ${sarajevoTime(now)}`,
        html: `
            ...
            <div style="padding: 32px 40px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 28px;">
                ...
                <tr><td style="padding-bottom: 8px;">
                  <div style="background:#F7F7F7;border-radius:8px;padding:10px 14px;">
                    <p style="margin:0 0 3px;font-size:10px;font-weight:700;color:#AAAAAA;text-transform:uppercase;">${lbl}</p>
              ...
              <table style="width: 100%; border-collapse: collapse;">
                ...
                <tr style="border-top: 2px solid #F0F0F0;">
                  ...
                  <td style="padding: 14px 0 0; color: #111111; font-size: 20px; font-weight: 800;">${fmtKM(ukupno)}</td>
                </tr>
              </table>
            </div>
    ...
    console.error("Patike order route error:", err);
    return NextResponse.json(
