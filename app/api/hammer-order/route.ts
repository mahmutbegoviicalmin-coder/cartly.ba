  ...
  try {
    ...
    const { error: dbError } = await getSupabaseAdmin()
      ...
      .insert({
        ...
        adresa,
        grad,
        velicine: [{ velicina: `Hammer S3 — br. ${velicina}`, kolicina: qty }],
        ukupno_pari: qty,
        cijena_proizvoda,
        dostava: DELIVERY,
        ukupno,
    ...
    sendCAPIEvent({
      ...
      value:       ukupno,
      currency:    "BAM",
      contentName: "Hammer S3 Radne Patike",
      phone:       telefon,
    ...
    try {
      ...
      await resend.emails.send({
        ...
        subject: `#NARUDZBA [HAMMER S3] - ${ime} - br.${velicina} x${qty} - ${sarajevoTime(now)}`,
        html: `
          <div style="font-family: Inter, -apple-system, sans-serif; max-width: 600px; margin: 0 auto; background: #fff; border: 1px solid #F0F0F0;">
            ...
            <div style="padding: 32px 40px;">
              ...
              <table style="width:100%; border-collapse:collapse;">
                <tr><td style="padding:7px 0; color:#888; font-size:14px; width:140px;">Proizvod</td><td style="padding:7px 0; font-weight:600; font-size:14px; color:#0A0A0A;">Hammer S3 Radne Patike</td></tr>
    ...
    console.error("Hammer order route error:", err);
