...
import {
  ...
  X, Menu, ChevronDown, ChevronUp, Play, HardDrive, CloudRain, Mic,
  MapPin,
} from "lucide-react";
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      if (typeof window !== "undefined" && (window as any).fbq) {
        (window as any).fbq("track", "Purchase", { value: total, currency: "BAM", content_name: "V380 Pro 12MP Kamera", content_ids: ["kamera-v380"], num_items: qty }, { eventID: data.orderNumber });
      }
      setDone(true);
    } catch (err) {
